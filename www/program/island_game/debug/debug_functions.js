...
import { DebugCube, DebugAudioSpere } from "./debug_gizmos.js";
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

 function __buildPhysicsWireframes() {
...
function __buildGizmos(){
  //// Create gizmos for sound objects
  g.SCENE.traverse((child) => {
    if (child.name.startsWith("SOUND__")) {
      // find the Audio object and get the max distance
      console.log(child);
      const maxDistance = child.userData.sound.getMaxDistance();
      console.log(maxDistance);
      const gizmo = new DebugAudioSpere(
        child.position,
        maxDistance,
        child.name
      );
...
export function variableTracking(div, rayHit=null){
  ...
  if (rayHit) {
    ...
    const triangle = __drawDebugTriangle(rayHit);
...
function __drawDebugTriangle(rayhit){
